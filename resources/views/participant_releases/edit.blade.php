            ...
            <div class="container">
                <div class="container mt-5">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('participant_releases.update', $participant_release->id)}}" method="post">
                                @csrf
                                @method('PUT')
                                        ...
                                        <select class="form-control" id="users_id" name="users_id" required>
                                                <option value="users_id">Seleccione un usuario
                                                    @foreach ($users as $user)
                                                        <option value="{{ $user->id }}" {{ $user->id == $participant_release->users_id ? 'selected' : ''}}>{{ $user->id }} {{ $user->name }}</option>
                                                    @endforeach
                                                </option>
                                        </select>
                                    </label>
                                        ...
                                        <select class="form-control" id="releases_id" name="releases_id" required>
                                                <option value="releases_id">Seleccione un lanzamiento
                                                    @foreach ($releases as $release)
                                                        <option value="{{ $release->id }}" {{ $release->id == $participant_release->releases_id ? 'selected' : ''}}>{{ $release->id }} {{ $release->name }}</option>
                                                    @endforeach
                                                </option>
                                        </select>
                                    </label>
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    ...
                                    <a href="{{ route('participant_releases.index') }}" class="btn btn-secondary">Volver</a>
                                </div>
                            </form>
                        </div>
                    </div>
