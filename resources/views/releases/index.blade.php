...
<html lang="en">
    <head>
        <title>8-bit Emporium |Lanzamientos</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <section id="register" class="container-grid padding-large position-relative overflow-hidden">
            <div class="container">
                ...
                <div class="container mt-5">
                    <h1 class=" text-center text-uppercase mb-4 text-black">Suscripcion a Lanzamientos</h1>
                    <div class="card mb-4">
                        <div class=" text-center card-header bg-primary text-white">
                            <h4>Agregar lanzamiento</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('releases.store')}}" method="post">
                                @csrf
                                <div class="d-flex flex-column align-items-center">
                                    <label for="name" class="text-align: center form-label">Nombre del Lanzamiento</label>
                                    <input type="text" name="name" id="name" class="form-control" required placeholder="Ingrese un nombre">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="label" class="text-center form-label">Fecha del lanzamiento</label>
                                    <input type="date" name="date" id="date" class="form-control" required placeholder="Ingrese una fecha">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="description" class="text-center form-label">Descripción del Lanzamiento</label>
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    <a href="{{ route('report.releases.pdf') }}" class="btn btn-danger me-2">Exportar PDF</a>
                                    <a href="{{ route('report.releases.excel') }}" class="btn btn-success">Exportar Excel</a>
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-hover" style="border-radius: 10px; overflow: hidden;">
                            ...
                            <tbody>
                                @foreach ($releases as $release)
                                    <tr>
                                        <td style="text-align: center;">{{ $release->name }}</td>
                                        <td style="text-align: center;">{{ $release->date }}</td>
                                        <td style="text-align: center;">{{ $release->description }}</td>
                                        <td>
                                            <div class="d-flex align-items-center justify-content-center">
                                                <form action="{{ route('releases.edit', $release->id) }}" method="GET" class="me-2">
        ...
        <script src="{{ asset('js/ReleasesValidation.js') }}"></script>
