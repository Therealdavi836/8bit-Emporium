                        ...
                        <div class="card-body">
                            <form action="{{ route('releases.update', $release->id)}}" method="post">
                                ...
                                <div class="d-flex flex-column align-items-center">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" required value="{{ $release->name }}" placeholder="Ingrese un nombre">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="label" class="text-center form-label">Fecha del lanzamiento</label>
                                    <input type="date" name="date" id="date" class="form-control" required value="{{ $release->date}}" placeholder="Ingrese una fecha">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="description" class="text-center form-label">Descripción del lanzamiento</label>
                                    <input type="text" name="description" id="description" class="form-control" required value="{{ $release->description}}" placeholder="Ingrese una descripción">
                                </div>

                                <div class="d-flex justify-content-center mt-4">
                                    <button type="submit" class="btn btn-success center" id="saveButton">Guardar</button>
                                    <a href="{{ route('releases.index') }}" class="btn btn-secondary">Volver</a>
                                </div>
                            </form>
                        </div>
                    </div>
