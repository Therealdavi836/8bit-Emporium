            ...
            <div class="container">
                <div class="container mt-5">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('category_details.update', $category_detail->id)}}" method="post">
                                @csrf
                                @method('PUT')
                                        ...
                                        <select class="form-control" id="videogames_id" name="videogames_id" required>
                                                <option value="videogames_id">Seleccione un videojuego
                                                    @foreach ($videogames as $videogame)
                                                        <option value="{{ $videogame->id }}" {{ $videogame->id == $category_detail->videogames_id ? 'selected' : ''}}>{{ $videogame->id }} {{ $videogame->title }}</option>
                                                    @endforeach
                                                </option>
                                        </select>
                                    </label>
                                        ...
                                        <select class="form-control" id="categories_id" name="categories_id" required>
                                                <option value="categories_id">Seleccione una categoria
                                                    @foreach ($categories as $categorie)
                                                        <option value="{{ $categorie->id }}" {{ $categorie->id == $category_detail->categories_id ? 'selected' : ''}}>{{ $categorie->id }} {{ $categorie->name }}</option>
                                                    @endforeach
                                                </option>
                                        </select>
                                    </label>
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    ...
                                    <a href="{{ route('category_details.index') }}" class="btn btn-secondary">Volver</a>
                                </div>
                            </form>
                        </div>
                    </div>
