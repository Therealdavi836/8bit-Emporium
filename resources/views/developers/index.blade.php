...
<html lang="en">
    <head>
        <title>8-bit Emporium |Desarrolladores</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <section id="register" class="container-grid padding-large position-relative overflow-hidden">
            <div class="container">
                <div class="container mt-5">
                    <h1 class=" text-center text-uppercase mb-4 text-black">Registro de desarolladores</h1>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('developers.store')}}" method="post">
                                ...
                                <div class="d-flex flex-column align-items-center">
                                    <label for="name" class="text-align: center form-label">Nombre del desarrollador</label>
                                    <input type="text" name="name" id="name" class="form-control" required placeholder="Ingrese un nombre">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="country" class="text-center form-label">Pais del desarrollador</label>
                                    <input type="text" name="country" id="country" class="form-control" required placeholder="Ingrese un país">
                                </div>
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    <a href="{{ route('report.developer.pdf') }}" class="btn btn-danger me-2">Exportar PDF</a>
                                    <a href="{{ route('report.developer.excel') }}" class="btn btn-success">Exportar Excel</a>
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($developers as $developer)
                                    <tr>
                                        ...
                                        <td style="text-align: center;">{{ $developer->country }}</td>
                                        <td style="text-align: center;">
                                            <div class="d-flex align-items-center justify-content-center">
                                                <form action="{{ route('developers.edit', $developer->id) }}" method="GET" class="me-2">
        ...
        <script src="{{ asset('js/DeveloperFormValidation.js') }}"></script>
