                        ...
                        <div class="card-body">
                            <form action="{{ route('developers.update', $developer->id)}}" method="post">
                                ...
                                <div class="d-flex flex-column align-items-center">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" required value="{{ $developer->name }}" placeholder="Ingrese un nombre">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="country" class="text-center form-label">Pais del desarrollador</label>
                                    <input type="text" name="country" id="country" class="form-control" required value="{{ $developer->country }}" placeholder="Ingrese un país">
                                </div>

                                <div class="d-flex justify-content-center mt-4">
                                    <button type="submit" class="btn btn-success center" id="saveButton">Guardar</button>
                                    <a href="{{ route('developers.index') }}" class="btn btn-secondary">Volver</a>
                                </div>
                            </form>
                        </div>
                    </div>
