...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <div class="container mt-5">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('promotion_details.update', $promotion_detail->id)}}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="d-flex flex-column align-items-center">
                                    <label for="videogame_id" class="text-center form-label">Nombre del videojuego
                                        <select class="form-control" id="videogame_id" name="videogame_id" required>
                                            <option value="videogame_id">Seleccione un videojuego</option>
                                            @foreach ($videogames as $videogame)
                                                <option value="{{ $videogame->id }}" {{ $videogame->id == $promotion_detail->videogame_id ? 'selected' : ''}}>{{ $videogame->id }} {{ $videogame->title }}</option>
                                            @endforeach
                                        </select>
                                    </label>
                                </div>
                                ...
                                <div class="d-flex flex-column align-items-center">
                                    <label for="promotion_id" class="text-center form-label">Nombre de la promoción
                                        <select class="form-control" id="promotion_id" name="promotion_id" required>
                                            <option value="promotion_id">Seleccione una promoción</option>
                                            @foreach ($promotions as $promotion)
                                                <option value="{{ $promotion->id }}" {{ $promotion->id == $promotion_detail->promotion_id ? 'selected' : ''}}>{{ $promotion->id }} {{ $promotion->name }}</option>
                                            @endforeach
                                        </select>
                                    </label>
                                </div>
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    ...
                                    <a href="{{ route('promotion_details.index') }}" class="btn btn-secondary">Volver</a>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <script src="{{ asset('js/PromotionDetailValidation.js') }}"></script>
