                ...
                <div class="container mt-5">
                    ...
                    <div class="card mb-4">
                        <div class=" text-center card-header bg-primary text-white">
                            ...
                            <div class="card-header-desc" style="background-color: white; border-radius: 10px;">
                                <p style="color: red;"> ¡ADVERTENCIA! La manipulación de la información puede resultar en penas y sanciones por parte del staff, edite solo cuando lo requiera el usuario.</p>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('users.update', $user->id)}}" method="post">
                                ...
                                <div class="d-flex flex-column align-items-center">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" required value="{{ $user->name }}" placeholder="Ingrese un nombre">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="email" class="text-center form-label">Correo electronico</label>
                                    <input type="text" name="email" id="email" class="form-control" required value="{{ $user->email }}" placeholder="Ingrese un correo electronico">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="password" class="text-center form-label">Contraseña</label>
                                    <input type="password" name="password" id="password" class="form-control" required value="{{ $user->password }}" placeholder="Ingrese una contraseña">
                                </div>
