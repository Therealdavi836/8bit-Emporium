...
<html lang="en">
    <head>
        <title>8-bit Emporium |Usuarios</title>
        <meta charset="utf-8">
        ...
        <section id="register" class="container-grid padding-large position-relative overflow-hidden">
            <div class="container">
                ...
                <div class="container mt-5">
                    <h1 class=" text-center text-uppercase mb-4 text-black">Registro de usuarios por parte de la administración</h1>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('users.store')}}" method="post">
                                ...
                                <div class="d-flex flex-column align-items-center">
                                    <label for="role_id" class="text-center form-label">Rol
                                ...
                                <div class="d-flex flex-column align-items-center">
                                    <label for="name" class="text-align: center form-label">Nombre del usuario</label>
                                    <input type="text" name="name" id="name" class="form-control" required placeholder="Ingrese un nombre">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="email" class="text-center form-label">Correo electronico</label>
                                    <input type="text" name="email" id="email" class="form-control" required placeholder="Ingrese un correo electronico">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="password" class="text-center form-label">Contraseña</label>
                                    <input type="password" name="password" id="password" class="form-control" required placeholder="Ingrese una contraseña">
                                </div>
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    <a href="{{ route('report.users.pdf') }}" class="btn btn-danger me-2">Exportar PDF</a>
                                    <a href="{{ route('report.users.excel') }}" class="btn btn-success">Exportar Excel</a>
                                </div>
                            </form>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center justify-content-center">
                                                <form action="{{ route('users.edit', $user->id) }}" method="GET" class="me-2">
