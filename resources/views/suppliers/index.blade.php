...
<html lang="en">
    <head>
        <title>8-bit Emporium |Proveedores</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <section id="register" class="container-grid padding-large position-relative overflow-hidden">
            <div class="container">
                ...
                <div class="container mt-5">
                    <h1 class=" text-center text-uppercase mb-4 text-black">Registro de proveedores</h1>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('suppliers.store')}}" method="post">
                                ...
                                <div class="d-flex flex-column align-items-center">
                                    <label for="name" class="text-align: center form-label">Nombre del proveedor</label>
                                    <input type="text" name="name" id="name" class="form-control" required placeholder="Ingrese un nombre">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="address" class="text-center form-label">Dirección asociada</label>
                                    <input type="text" name="address" id="address" class="form-control" required placeholder="Ingrese una dirección">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="phone" class="text-center form-label">Telefono del proveedor</label>
                                    <input type="text" name="phone" id="phone" class="form-control" required placeholder="Ingrese un telefono">
                                </div>
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    <a href="{{ route('report.suppliers.pdf') }}" class="btn btn-danger me-2">Exportar PDF</a>
                                    <a href="{{ route('report.suppliers.excel') }}" class="btn btn-success">Exportar Excel</a>
                                </div>
                            </form>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center justify-content-center">
                                                <form action="{{ route('suppliers.edit', $supplier->id) }}" method="GET" class="me-2">
        ...
        <script src="{{ asset('js/SupplierValidation.js') }}"></script>
