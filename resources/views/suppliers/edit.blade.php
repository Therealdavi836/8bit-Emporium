                        ...
                        <div class="card-body">
                            <form action="{{ route('suppliers.update', $supplier->id)}}" method="post">
                                ...
                                <div class="d-flex flex-column align-items-center">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" required value="{{ $supplier->name }}" placeholder="Ingrese un nombre">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="address" class="text-center form-label">Dirección del proveedor</label>
                                    <input type="text" name="address" id="address" class="form-control" required value="{{ $supplier->address}}" placeholder="Ingrese una dirección">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="phone" class="text-center form-label">Telefono del proveedor</label>
                                    <input type="text" name="phone" id="phone" class="form-control" required value="{{ $supplier->phone}}" placeholder="Ingrese un telefono">
                                </div>
