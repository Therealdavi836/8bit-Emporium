                ...
                <div class="container mt-5">
                    ...
                    <div class="card mb-4">
                        <div class=" text-center card-header bg-primary text-white">
                            <h4>Editar detalle de la plataforma</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('platform_details.update', $platform_detail->id)}}" method="post">
                                @csrf
                                @method('PUT')
                                        ...
                                        <select class="form-control" id="videogames_id" name="videogames_id" required>
                                                <option value="videogames_id">Seleccione un videojuego
                                                    @foreach ($videogames as $videogame)
                                                        <option value="{{ $videogame->id }}" {{ $videogame->id == $platform_detail->videogames_id ? 'selected' : ''}}>{{ $videogame->id }} {{ $videogame->title }}</option>
                                                    @endforeach
                                                </option>
                                        </select>
                                    </label>
                                ...
                                <div class="d-flex flex-column align-items-center">
                                    <label name ='platforms_id' class="text-center form-label">Seleccione la categoria
                                        <select class="form-control" id="platforms_id" name="platforms_id" required>
                                                <option value="platforms_id">Seleccione una plataforma
                                                    @foreach ($platforms as $platform)
                                                        <option value="{{ $platform->id }}" {{ $platform->id == $platform_detail->platforms_id ? 'selected' : ''}}>{{ $platform->id }} {{ $platform->name }}</option>
                                                    @endforeach
                                                </option>
                                        </select>
                                    </label>
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    ...
                                    <a href="{{ route('platform_details.index') }}" class="btn btn-secondary">Volver</a>
                                </div>
                            </form>
                        </div>
                    </div>
