                        ...
                        <div class="card-body">
                            <form action="{{ route('roles.update', $role->id)}}" method="post">
                                ...
                                <div class="d-flex flex-column align-items-center">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" required value="{{ $role->name }}" placeholder="Ingrese un nombre">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="label" class="text-center form-label">Etiqueta asociada</label>
                                    <input type="text" name="label" id="label" class="form-control" required value="{{ $role->label}}" placeholder="Ingrese una etiqueta">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="description" class="text-center form-label">Descripción del rol</label>
                                    <input type="text" name="description" id="description" class="form-control" required value="{{ $role->description}}" placeholder="Ingrese una descripción">
                                </div>
