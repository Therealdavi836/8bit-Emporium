...
<html lang="en">
    <head>
        <title>8-bit Emporium |Roles</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <section id="register" class="container-grid padding-large position-relative overflow-hidden">
            <div class="container">
                ...
                <div class="container mt-5">
                    <h1 class=" text-center text-uppercase mb-4 text-black">Registro de roles</h1>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('roles.store')}}" method="post">
                                ...
                                <div class="d-flex flex-column align-items-center">
                                    <label for="name" class="text-align: center form-label">Nombre del rol</label>
                                    <input type="text" name="name" id="name" class="form-control" required placeholder="Ingrese un nombre">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="label" class="text-center form-label">Etiqueta asociada</label>
                                    <input type="text" name="label" id="label" class="form-control" required placeholder="Ingrese una etiqueta">
                                </div>

                                <div class="d-flex flex-column align-items-center">
                                    <label for="description" class="text-center form-label">Descripción del rol</label>
                        ...
                        <tbody>
                            @foreach ($roles as $role)
                                <tr>
                                    ...
                                    <td style="text-align: center;">{{ $role->label }}</td>
                                    <td style="text-align: center;">{{ $role->description }}</td>
                                    <td>
                                        <div class="d-flex align-items-center justify-content-center">
                                            <form action="{{ route('roles.edit', $role->id) }}" method="GET" class="me-2">
        ...
        <script src="{{ asset('js/RolesValidation.js') }}"></script>
